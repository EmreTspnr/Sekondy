            ...
            {ads.map(ad => (
              <div key={ad._id} className="flex flex-col sm:flex-row items-start sm:items-center p-5 hover:bg-gray-50 transition-colors gap-5">
                ...
                <div className="flex sm:flex-col gap-2 w-full sm:w-auto mt-4 sm:mt-0">
                  ...
                  <Link to={`/edit-ad/${ad._id}`} className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-3 py-2 border border-gray-200 rounded-lg text-sm font-semibold text-gray-600 hover:text-blue-500 hover:border-blue-500 transition-colors">

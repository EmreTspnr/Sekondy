...
const CATEGORIES = ['Emlak', 'Vasıta', 'Elektronik', 'Ev & Bahçe', 'Moda', 'Spor & Eğlence', 'Hizmetler', 'Evcil Hayvanlar'];
...
export default function PostAd() {
  ...
  // Handle fake drop logic for visual purposes
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Mock resim servisi - Asıl yapıda cloudinary gelecek
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-8 w-full mt-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={() => window.location.href='/'} className="text-sm text-gray-500 hover:text-black font-medium">
          İptal Et
        </button>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
        <form className="p-6 md:p-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-5 pt-4">
            ...
            <div>
              ...
              <textarea 
                ...
                placeholder="Ürünün özelliklerini detaylıca yazın..."
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  placeholder="Şehir veya Mahalle"
          ...
          <div className="pt-6 border-t border-gray-100 flex justify-end gap-3">
            ...
            <button 
              type="submit" 
              className="bg-[#D4AF37] hover:bg-[#c19b2e] text-black font-bold py-3 px-8 rounded-lg transition-colors shadow-md"
            >
              İlanı Yayınla
            </button>
          </div>
